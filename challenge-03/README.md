...
*/
var pessoa = { nome: 'Paulo', sobrenome: 'Dias', sexo: 'Masculino', idade: 22, altura: 1.83, peso: 72, andando: false, caminhouQuantosMetros: 0 };
...
*/
pessoa.nomeCompleto() /* Olá! Meu nome é Paulo Dias! */
